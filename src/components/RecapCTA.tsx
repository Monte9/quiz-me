      ...
      <div className="grid gap-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-raised)] p-8 sm:p-12 md:grid-cols-[1.2fr_1fr]">
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link
              href="/monte"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--color-accent)] px-6 py-3 text-sm font-semibold text-[var(--color-bg)] transition-all hover:bg-[var(--color-accent-bright)] hover:shadow-[0_0_30px_var(--color-accent-glow)]"
            >
              Try it now →
            </Link>
            <a
              href="mailto:manthan.thakkar@gmail.com?subject=Quiz%20Me%20invite"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--color-border-strong)] bg-[var(--color-surface)] px-6 py-3 text-sm font-semibold text-[var(--color-text-dim)] transition-all hover:border-[var(--color-accent-dim)] hover:text-[var(--color-text)]"
            >
              Ask for an invite
            </a>
          </div>
